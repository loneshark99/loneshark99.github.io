...
|-------------|------------|----------|-----------------|
| [Advanced Java Development](https://learning.oreilly.com/course/advanced-java-development/9781491960400/) | Ken Kousen | O'Reilly Media (On-demand) | Advanced Java concepts and modern development practices |
| [Functional Programming in Java](https://learning.oreilly.com/live-events/functional-programming-in-java/0636920071136/) | Ken Kousen | O'Reilly Media (Live Course) | Functional programming paradigms in Java |
| [Learning Reflection with Java](https://www.linkedin.com/learning/learn-reflection-with-java/method?u=3322) | Various | LinkedIn Learning | Java reflection API and meta-programming |
