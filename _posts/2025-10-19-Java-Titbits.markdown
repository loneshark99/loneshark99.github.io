...
- Tools window is very useful in Java to view the project files <br>
**IntelliJ ShortCut :: ALT + 1**
  
- Tools window is very useful in Java to view Run window <br>
**IntelliJ ShortCut :: ALT + 4**
  
- Tools windows to view the GIT <br>
